...
mobileSeeProjectButtons.forEach((mobileSeeProjectButton, index) => {
  mobileSeeProjectButton.addEventListener('click', () => clickProjectListener(index));
});

// close modal
const closeModal = document.querySelector('.close-modal');
closeModal.addEventListener('click', () => document.querySelector('.mobile-project-modal').classList.toggle('show'));